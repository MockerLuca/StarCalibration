...
def GHB2D(calibration_file, dE_strips_num, E_strips_num, bins_num, channel_i, channel_f,noise):
...
def GHA2D(calibration_file, dE_strips_num, E_strips_num, bins_num, channel_i, channel_f,noise):
...
def GHEB1D(calibration_file, strips_num, bins_num, channel_i, channel_f, noise):
	...
	root_file = ROOT.TFile.Open(str(calibration_file))
	tree = root_file.T
	entries = tree.GetEntries()
